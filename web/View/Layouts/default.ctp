...
<body>
	<div id="container">
		...
		<div class="actions" style="width:95%">
			<ul>
				<li style="display: inline-block;"><?php echo $this->Html->link(__("Clients", true), array("controller"=>'clients', 'action' => 'index'));?></li>
				<li style="display: inline-block;"><?php echo $this->Html->link(__("Projects", true), array("controller"=>'projects', 'action' => 'index'));?></li>
			</ul>
		</div>
